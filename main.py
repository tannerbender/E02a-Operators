...
def orderOperations(a1,a2,a3):
    ...
    '''
    toReturn = 0
    toReturn = mult(add(a1,a2),a3)# add your code here
    return toReturn
...
def whichType(t):
    ...
    '''
    toReturn = ''
    toReturn = type(t)# add your code here
    return toReturn
...
def convertInt(i):
    ...
    '''
    toReturn = 0
    toReturn = int(i) # add your code here
    return toReturn
...
def convertFloat(f):
    ...
    '''
    toReturn = 0.0
    toReturn = float(f) # add your code here
    return toReturn
...
def convertStr(s):
    ...
    '''
    toReturn = ''
    toReturn = str(s) # add your code here
    return toReturn
...
def concat(s1,s2):
    ...
    '''
    toReturn = ''
    toReturn = s1 + s2 # add your code here
    return toReturn
...
def whichChar(s,a):
    ...
    '''
    toReturn = ''
    toReturn = s[a]# add your code here
    return toReturn
...
def substr(s,a1,a2):
    ...
    '''
    toReturn = ''
    toReturn = s[a1:a2]# add your code here
    return toReturn
...
def reverseStr(s):
    ...
    '''
    toReturn = ''
    toReturn = s[::-1]# add your code here
    return toReturn
...
def isIn(l,e):
    ...
    '''
    toReturn = ''
    toReturn = e in l# add your code here
    return toReturn
...
def randomElement(l):
    ...
    toReturn = l[index] # add your code here
    return toReturn
...
def randomNumber():
    ...
    '''
    toReturn = 0
    toReturn = random.randint(1000,9999)# add your code here
    return toReturn
...
def shuffleList(l):
    ...
    toReturn = []
    toReturn = l 
    random.shuffle(toReturn)# add your code here
    return toReturn
...
def listUntil(a):
    ...
    '''
    toReturn = []
    toReturn = list(range(0,a))# add your code here
    return toReturn
